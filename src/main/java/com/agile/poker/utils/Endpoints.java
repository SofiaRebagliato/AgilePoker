package com.agile.poker.utils;

public class Endpoints {
    public static final String CARDS = "/api/agilepoker/cards";
    public static final String DECKS = "/api/agilepoker/decks";
    public static final String MATCHES = "/api/agilepoker/matches";
    public static final String PARTICIPATIONS = "/api/agilepoker/participations";
    ...
    public static final String GET_PARTICIPATIONS = "/listParticipations";
